...
import com.rwa.tellme.tellme.DataDummy
import com.rwa.tellme.tellme.MainDispatcherRule
import com.rwa.tellme.tellme.getOrAwaitValue
...
class MainStoryEntityViewModelTest{
    @get:Rule
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(storyRepository.getAllStoryWithPager()).thenReturn(expectedStory)
        val actualStory: PagingData<StoryModel> = mainStoryViewModel.story.getOrAwaitValue()
    ...
    fun `when Get Story Empty Should Return No Data`() = runTest {
        ...
        Mockito.`when`(storyRepository.getAllStoryWithPager()).thenReturn(expectedQuote)
        val actualQuote: PagingData<StoryModel> = mainStoryViewModel.story.getOrAwaitValue()
